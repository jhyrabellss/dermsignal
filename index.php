...
<body>
    <div class="nav-notification">
        You are viewing a demo version of DermSignal. Some features may be limited.
    </div>
    <nav>
        <div class="nav-logo">
        ...
        <div class="nav-text-cont">
            <div class="nav-concern-cont">
                ...
                <svg id="tabler-icon-chevron-down_1_" data-name="tabler-icon-chevron-down (1)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path id="Path_116046" data-name="Path 116046" d="M0,0H24V24H0Z" fill="none"></path>
                    <path id="Path_116047" data-name="Path 116047" d="M6,9l6,6,6-6" fill="none" stroke="#279989" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                </svg>
            </div>
            ...
            <div>
                <a href="./components/services.php">Services</a>
            </div>
            <a href="./components/assessment.php">
                <div class="nav-free-skin-assessment-cont">
                    <svg id="tabler-icon-clipboard-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path id="Path_116054" data-name="Path 116054" d="M0,0H24V24H0Z" fill="none"></path>
                        <path id="Path_116055" data-name="Path 116055" d="M9,5H7A2,2,0,0,0,5,7V19a2,2,0,0,0,2,2H17a2,2,0,0,0,2-2V7a2,2,0,0,0-2-2H15" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <rect id="Rectangle_7428" data-name="Rectangle 7428" width="6" height="4" rx="2" transform="translate(9 3)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></rect>
                        <path id="Path_116056" data-name="Path 116056" d="M9,14l2,2,4-4" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                    </svg>
        ...
        <div class="nav-right-icon" style="display:flex; gap: 20px;  ">
            ...
            ?>
                ...
                <a href="./components/my-appointments.php">
                ...
                <a href="./components/concern-prod.php?concern_id=1">
                    <div class="concern-cont" id="Acne" onclick="concernHTMLIndex('Acne/Pimple')">
                        ...
                        <div class="name-arrow">
                            <p>Acne</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" stroke="#279989" viewBox="0 0 19 20.243">
                                <defs>
                                    <style>
                                        .right-arrow {
                                            fill: none;
                                ...
                                <g transform="translate(25 -5.379) rotate(90)">
                                    <path class="right-arrow" d="M18,23.5V7.5" transform="translate(-2.5)"></path>
                                    <path class="right-arrow" d="M7.5,15.5l8-8,8,8" transform="translate(0 0)"></path>
                                </g>
                            </svg>
                        </div>
                    </div>
    ...
    <?php include "./components/voucher-banner.php" ?>
    ...
    <footer>
        <div class="footer-choices">
            ...
            <div class="footer-queries">
                ...
                <a href="./components/contacts.php">
                    <div>Contact Us</div>
                </a>
            </div>
            ...
            <div class="footer-details">
                ...
                <div class="footer-options">
                    ...
                    <div class="learn">
                        ...
                        <a href="./components/blogs.php">
                            <p>Blog</p>
                        </a>
                    </div>
                    <div class="help">
                        <h5>Help & Support</h5>
                        <a href="./components/faqs.php">
                            <p>FAQs</p>
                        </a>
                        <a href="./components/terms-condition.php">
                            <p>Terms & Conditions</p>
                        </a>
                        <a href="./components/privacy-policy.php">
                            <p>Privacy Policy</p>
                        </a>
                    </div>
                </div>

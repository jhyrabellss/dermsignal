...
?>
        ...
        <div class="page-header">
            ...
            <a href="../components/orders.php"><div class="order-status">View Current Orders</div></a>
        </div>
                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <?php if (isset($vouchersByDate[$orderDate]) && count($vouchersByDate[$orderDate]) > 0) { ?>
                                ...
                                <?php foreach ($vouchersByDate[$orderDate] as $voucher) {
                                    $targetItems = json_decode($voucher['target_items'], true);
                                    $eligibleProductIds = [];
                            ...
                            <tr class="summary-row">
                                ...
                                <td class="discount-text"><strong>-₱<?php echo number_format($voucherDiscount, 2); ?></strong></td>
                            </tr>
                            <?php } ?>

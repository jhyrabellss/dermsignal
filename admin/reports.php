              ...
              <div class="card mb-5">
                    ...
                    <div class="card-body">
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          <?php
                            $query = "SELECT tf.*, CONCAT(td.first_name, ' ', td.last_name) AS full_name, tp.prod_name FROM tbl_item_reviews tf
                          ...
                          ?>
                          <tr>
                            <td><?php echo $data['rv_id'];?></td>
                            <td><?php echo $data['full_name'];?></td>
                            <td><?php echo $data['prod_name'];?></td>
                            <td>
                                <button type="button" class="btn btn-primary" id="<?php echo $data["rv_id"] ?>"  data-bs-toggle="modal" 
                                data-bs-target="#residenceAccountDetails<?php echo $data["rv_id"] ?>" data-bs-whatever="@getbootstrap">
                                  <i class="fa-solid fa-eye" style="color: #fcfcfc;"></i>
                                </button>
                            </td>
                          </tr>
                            <div class="modal fade" id="residenceAccountDetails<?php echo $data["rv_id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">

              ...
              <div class="card mb-5">
                    ...
                    <div class="card-body">
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          <?php
                            $query = "SELECT ta.ac_id, CONCAT(tc.first_name, ' ', tc.middle_name, ' ', tc.last_name) AS full_name, tc.contact, tc.address FROM tbl_account ta INNER JOIN tbl_account_details tc ON tc.ac_id = ta.ac_id WHERE ta.role_id = 1 AND ta.account_status_id = 1;";
                          ...
                          <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger deactivateResBtn" id="<?php echo $data["ac_id"] ?>" >

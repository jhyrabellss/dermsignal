                        ...
                        <table class="table table-striped table-sm order-table">
                          ...
                          <tbody>
                            ...
                            <?php if (isset($vouchersByDateAccount[$groupKey]) && count($vouchersByDateAccount[$groupKey]) > 0) { ?>
                              ...
                              <?php
                              // Track displayed vouchers to avoid duplicates
                              $displayedVouchers = [];

                              foreach ($vouchersByDateAccount[$groupKey] as $voucher) {
                                // Skip if this voucher was already displayed
                            ...
                            <?php if ($actualVoucherDiscount > 0) { ?>
                              <tr>
                                ...
                                <td style="color: #f03e3e;"><strong>-₱<?php echo number_format($actualVoucherDiscount, 2); ?></strong></td>
                              </tr>
                            <?php } ?>
                            <tr>
                              <td colspan="7"></td>
